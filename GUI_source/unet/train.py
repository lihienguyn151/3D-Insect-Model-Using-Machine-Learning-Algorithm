...
dir_img = "/content/drive/MyDrive/Colab Notebooks/U-Net+VGG16/images"
dir_mask = "/content/drive/MyDrive/Colab Notebooks/U-Net+VGG16/masks"
dir_checkpoint = "/content/drive/MyDrive/Colab Notebooks/U-Net+VGG16/checkpoints"
...
def train_model(
    ...
    for epoch in range(1, epochs + 1):
        ...
        #Save best model
        if dice_score.item() > dice_best and epoch % 5 == 0:
            dice_best = dice_score.item()
            torch.save(model.state_dict(), str(dir_checkpoint + '/best_model.pth'))
            logging.info(f'<*> The best model is saved in {epoch} epoch!')
            print(f'<*> The best model is saved in {epoch} epoch!\n')
    ...
    #Confusion Matrix
    class_names = ["Background", "Đối tượng"]
...
def get_args():
    ...
    args.classes = ask("Number of classes:", int, 2)'''
